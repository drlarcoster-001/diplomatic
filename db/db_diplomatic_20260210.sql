...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-02-2026 a las 03:37:20
...
INSERT INTO `tbl_users` (`id`, `user_type`, `status`, `first_name`, `last_name`, `email`, `phone`, `document_id`, `password_hash`, `last_login_at`, `created_at`, `updated_at`, `role`) VALUES
(1, 'INTERNAL', 'ACTIVE', 'ADMIN', 'GENERAL', 'admin@diplomatic.local', NULL, NULL, '$2y$10$00VC/qpQDbIDycCmDk0.Au4AEP7EfpgQ8J451Zs9YOvzdH4Vpty5K', NULL, '2026-02-07 17:08:04', '2026-02-08 01:48:48', 'ADMIN'),
(2, 'INTERNAL', 'ACTIVE', 'JORGE', 'PEREIRA', 'jorgepereira@amarellus.com', '+584145365380', '14979523', '$2y$10$Pa.672SkyV7tzG8yfpeI5uInUoOt7T/YKWdtVa.dfqqsKjjLFn8pG', NULL, '2026-02-08 11:35:40', '2026-02-08 11:35:40', 'ADMIN');
