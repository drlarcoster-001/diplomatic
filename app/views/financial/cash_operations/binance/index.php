 ...
 * ARCHIVO: app/views/financial/cash_operations/binance/index.php
 * PROPÓSITO: Panel operativo para validación de pagos Binance (USDT) con visor de auditoría y protocolo de seguridad.
 * VERSIÓN: 1.0.0 - Clon exacto de la arquitectura Zelle para consistencia administrativa.
 */
...
<link rel="stylesheet" href="<?= htmlspecialchars($basePath) ?>/assets/css/financial_cash_operations_binance.css">
...
<div class="container-fluid py-4 animate__animated animate__fadeIn">
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb bg-light p-2 rounded shadow-sm border" style="font-size: 0.85rem;">
            ...
            <li class="breadcrumb-item active text-dark fw-bold" aria-current="page">Conciliación Binance Pay</li>
        </ol>
    </nav>

    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        <div>
            <h2 class="h4 fw-bold mb-0 text-dark">Gestión de Pagos Binance Pay (USDT)</h2>
            ...
            <form id="filter-form-binance" class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control border-start-0" id="search-text" placeholder="Ej: Order ID #">
                    </div>
                </div>
                <div class="col-md-2">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-white py-3">
            <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-list-check text-primary me-2"></i>Binance Pay Pendientes por Procesar</h6>
        </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-dark text-white">
                <h5 class="modal-title fw-bold"><i class="bi bi-shield-check me-2"></i>Auditoría de Pago Binance Pay</h5>
            ...
            <div class="modal-body p-0">
                <div class="row g-0">
                    <div class="col-lg-5 p-4 bg-light border-end">
                        ...
                        <div class="mb-3">
                            <label class="d-block small text-muted">Titular / ID Binance</label>
                            <span id="v-titular" class="fw-bold text-dark">-</span>
                        </div>
                        <div class="mb-3">
                            <label class="d-block small text-muted">Correo / Cuenta Binance</label>
                    ...
                    <div class="col-lg-7 d-flex flex-column bg-secondary bg-opacity-10" style="min-height: 600px;">
                        ...
                        <div class="flex-grow-1 overflow-auto d-flex align-items-center justify-content-center p-3" id="img-viewer-container">
                            <img src="" id="v-screenshot" class="img-fluid shadow" style="transition: transform 0.2s ease;" alt="Capture de Binance Pay">
                        </div>
                    </div>
                </div>
            </div>
...
<script src="<?= htmlspecialchars($basePath) ?>/assets/js/financial_cash_operations_binance.js"></script>