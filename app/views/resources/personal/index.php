            ...
            <form method="GET" action="<?= $basePath ?>/resources/personal" class="row g-3">
                <div class="col-md-10">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control border-start-0" placeholder="Buscar por nombre, cédula, expediente o tipo..." value="<?= htmlspecialchars($search ?? '') ?>">
                    </div>
                </div>
                <div class="col-md-2">
                    ...
                    <div class="card border-0 shadow-sm h-100 personal-card" style="border-top: 3px solid <?= $badgeColor ?> !important;">
                        <div class="card-body p-4 text-center">
                            ...
                            <div class="d-flex gap-1 justify-content-center flex-wrap">
                                ...
                                <button type="button"
                                        class="btn btn-sm btn-outline-secondary rounded-pill px-2 btn-carnet"
                                ...
                                <a href="<?= $basePath ?>/resources/personal/expediente?id=<?= $p['id'] ?>"
                                   ...
                                   target="_blank" title="Ver Expediente">
