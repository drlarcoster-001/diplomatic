 ...
 * Archivo: app/views/resources/contratos_plantillas/create.php
 * Propósito: Formulario de creación de plantilla con editor WYSIWYG y campos personalizados.
 * Versión: 1.2.0
 *
 * @var array $tipos
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold mb-0 text-dark">Nueva Plantilla de Contrato</h2>
            <p class="text-muted small">Diseñe el formato del contrato usando variables del sistema y campos personalizados.</p>
        </div>
    ...
    <form id="formPlantilla" action="<?= $basePath ?>/resources/contratos/plantillas/save" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="nombre" class="form-control"
                               placeholder="Ej: Prestación de Servicios - Profesor Teórico" required>
                    </div>
                    <div class="col-md-4">
