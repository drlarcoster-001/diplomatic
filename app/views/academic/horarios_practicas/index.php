 ...
 * ARCHIVO: app/views/academic/horarios_practicas/index.php
...
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-2" style="font-size: 0.85rem;">
            ...
            <li class="breadcrumb-item active fw-bold text-primary" aria-current="page">Horarios prácticos de Práctica</li>
        </ol>
    </nav>

    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 fw-bold mb-0 text-dark">Horarios prácticos de Práctica</h2>
            <p class="text-muted small mb-0">
                Ofertas abiertas o en curso. Selecciona una para configurar sus horarios de práctica y grupos.
                <?php if ($total > 0): ?>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-3">
            ...
            <form method="GET" action="<?= $basePath ?>/academic/horarios-practicas" class="row g-2 mb-3">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                    <?php if (!empty($periodoId) || !empty($diplomaId)): ?>
                        <a href="<?= $basePath ?>/academic/horarios-practicas" class="btn btn-outline-secondary w-100 rounded-pill">
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light small fw-bold text-secondary text-uppercase"
                        ...
                        <tr>
                            ...
                            <th>Grupos</th>
                            <th style="width: 100px;" class="text-center">Matriculados</th>
                            <th style="width: 120px;" class="text-center">Horarios prácticos</th>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <?php foreach ($ofertas as $idx => $o):
                                ...
                                $manageUrl = "{$basePath}/academic/horarios-practicas/manage?offering_id={$o['offering_id']}";
                                ...
                                <tr style="cursor: pointer;" onclick="window.location='<?= $manageUrl ?>'">
                                    ...
                                    <td class="text-center">
                                        <span class="badge rounded-pill px-3"
                                              style="background:#E6F1FB;border:1px solid #378ADD;color:#0C447C;font-weight:600">
                                            <i class="bi bi-person-check me-1"></i>
                                            <?= (int)$o['total_matriculados'] ?>
                                        </span>
                                    </td>
                                    <td class="text-center">
