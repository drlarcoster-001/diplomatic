 ...
 * Version: 1.2.0 - Integración de Breadcrumbs, remoción de columna Estado y dinamización de rutas.
 */
...
<link rel="stylesheet" href="<?= $basePath ?>/assets/css/academic_grupos.css">
...
<div class="container-fluid py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-2" style="font-size: 0.85rem;">
            ...
            <li class="breadcrumb-item active fw-bold text-primary" aria-current="page">Grupos</li>
        </ol>
    </nav>
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="<?= $basePath ?>/academic/grupos" class="row g-3">
                <div class="col-md-10">
    ...
    <div class="card border-0 shadow-sm overflow-hidden">
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    <?php if (empty($grupos)): ?>
                        <tr><td colspan="4" class="text-center py-4 text-muted">No se encontraron grupos registrados.</td></tr>
                    <?php else: ?>
                        <?php foreach ($grupos as $g): ?>
                            <tr>
                                ...
                                <td class="text-muted small"><?= htmlspecialchars($g['description'] ?: 'Sin descripción registrada.') ?></td>
...
<div class="modal fade" id="modalGrupoForm" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
        <form id="formGrupo" action="<?= $basePath ?>/academic/grupos/save" method="POST" class="modal-content border-0 shadow-lg">
...
<script src="<?= $basePath ?>/assets/js/academic_grupos.js?v=<?= time() ?>"></script>