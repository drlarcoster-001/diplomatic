...
<div class="dp-wrapper">
  <div class="dp-card">
    ...
    <div class="dp-tagline">Finalizar registro</div>
    <p class="dp-desc">Establezca una clave segura para su cuenta institucional.</p>
    ...
    <form id="formPassword" action="<?= $basePath ?>/register/create-password" method="POST" data-basepath="<?= $basePath ?>">
      ...
      <button type="submit" class="dp-btn-entrar">Validar y finalizar</button>
    </form>
