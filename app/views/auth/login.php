 ...
 * Propósito: Pantalla de acceso (Login) con funcionalidad "Recordarme" habilitada.
 */
    ...
    <div class="row g-4 align-items-center justify-content-center">
      ...
      <div class="col-12 col-lg-6">
        <div class="mb-4">
          ...
          <div class="dp-subtitle mt-2">Sistema de Gestión de Diplomados · Acceso institucional</div>
        </div>
        <div class="bg-white border rounded-4 p-4 dp-shadow">
          <div class="dp-title h5 mb-2">Ingreso al sistema</div>
          <div class="dp-subtitle mb-0">Ingrese sus credenciales para acceder al dashboard institucional.</div>
        </div>
      </div>
      ...
      <div class="col-12 col-lg-5">
        <div class="dp-card dp-shadow p-4 p-md-5">
          ...
          <form method="POST" action="<?= htmlspecialchars($basePath) ?>/login" novalidate>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
              <div class="form-check">
                ...
                <label class="form-check-label dp-subtitle" for="rememberMe">Recordarme</label>
              </div>
              <a class="text-decoration-none small" href="<?= htmlspecialchars($forgotUrl) ?>">¿Olvidé mi contraseña?</a>
            </div>
          ...
          <div class="text-center mt-4">
            ...
            <a class="btn btn-outline-secondary w-100" href="<?= htmlspecialchars($registerUrl) ?>">Registrarme</a>
          </div>
        </div>
      </div>
