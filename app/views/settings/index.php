...
<div class="container-fluid py-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-md-6 col-lg-4">
            <a href="<?= htmlspecialchars($basePath) ?>/settings/paymentMethods" class="text-decoration-none text-dark">
                <div class="card h-100 border-0 shadow-sm p-4 text-center settings-card-item">
                    <div class="bg-primary bg-opacity-10 text-primary p-3 rounded-circle mx-auto mb-3" style="width: fit-content;">
                        <i class="bi bi-credit-card-2-front fs-2"></i>
                    </div>
                    <h5 class="fw-bold">Métodos de Pago</h5>
                    <p class="text-muted small">Cuentas bancarias, Pago Móvil, Zelle y montos mínimos.</p>
                </div>
            </a>
        </div>

        <div class="col-md-6 col-lg-4">
            <a href="<?= htmlspecialchars($basePath) ?>/settings/seguridad" class="text-decoration-none text-dark">
                <div class="card h-100 border-0 shadow-sm p-4 text-center settings-card-item">
                    ...
                    <p class="text-muted small">Administración de pre-usuarios y tokens de activación.</p>
                </div>
            </a>
        </div>
