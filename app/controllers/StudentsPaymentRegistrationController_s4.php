...
// 2. MONTO NATIVO (lo que escribió el estudiante, sin tocar)
        ...
        $masterJson = [
            'metodo'               => $method,
            'monto_sistema_usd'    => number_format(round($montoSistemaUsd, 2), 2, '.', ''),
            'tasa_cambio'          => number_format(round($tasaFinal, 2), 2, '.', ''),
            'detalles_origen'      => [
            ...
            'detalles_transaccion' => [
                ...
                'monto_nativo'      => number_format(round($montoNativo, 2), 2, '.', ''),
