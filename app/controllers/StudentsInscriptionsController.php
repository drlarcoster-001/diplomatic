...
public function store(): void {
        ...
        try {
            ...
            if ($payMethod === 'PAGOMOVIL') {
                ...
                $rawMeta['monto_sistema_usd'] = $montoEnviadoUsd;
                $rawMeta['tasa_cambio']        = round($tasaValida, 2);
...
private function preparePaymentData(string $method, int $userId): array
    {
        ...
        $masterJson = [
            ...
            'monto_sistema_usd' => round($clean($rawMetadata['monto_sistema_usd'] ?? 0), 2),
            'tasa_cambio'       => round((float)($rawMetadata['tasa_cambio'] ?? 0), 2),
            'detalles_origen'   => [
            ...
            'detalles_transaccion' => [
                ...
                'monto_nativo'      => round($clean($rawMetadata['detalles_transaccion']['monto_nativo'] ?? 0), 2),
