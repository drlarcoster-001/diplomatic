 ...
 * ARCHIVO: public/assets/js/student_statement_voucher.js
 * PROPÓSITO: Visor flotante draggable de comprobantes de pago.
 * VERSIÓN: 1.0.0
 * DEPENDENCIAS: student_statement.js
 */
...
(function () {
    ...
    // ----------------------------------------------------------------
    //  FETCH AL ENDPOINT ESTUDIANTIL
    // ----------------------------------------------------------------
    async function fetchVoucher(tipo, referencia) {
        try {
            const baseUrl = window.BASE_URL || '/diplomatic/public';

            const url = `${baseUrl}/students/student_statement/getPaymentVoucher`
