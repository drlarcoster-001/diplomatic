 ...
 * ARCHIVO: public/assets/js/resources_tipos_contrato.js
 * PROPÓSITO: Gestionar la interactividad del catálogo de tipos de contrato.
 * VERSIÓN: 1.0.0
 */

$(document).ready(function () {
    const basePath = '/diplomatic/public/resources/tipos-contrato';
    ...
    if (urlParams.get('error') === 'in_use') {
        MySwal.fire({ icon: 'error', title: 'No se puede eliminar', text: 'Este tipo tiene plantillas de contrato vinculadas.', confirmButtonColor: '#0d6efd' });
    }
    if (urlParams.get('error') === 'duplicate') {
        MySwal.fire({ icon: 'error', title: 'Registro duplicado', text: 'Ya existe un tipo con ese nombre o siglas.', confirmButtonColor: '#0d6efd' });
    }
    ...
    document.getElementById('btnNuevoTipo').addEventListener('click', function () {
        ...
        document.getElementById('modalTipoTitle').innerText = 'Nuevo Tipo de Contrato';
    });
        ...
        btn.addEventListener('click', function (e) {
            ...
            fetch(`${basePath}/getDetails?id=${id}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('modalTipoTitle').innerText = 'Editar Tipo de Contrato';
        ...
        btn.addEventListener('click', function (e) {
            ...
            if (count > 0) {
                MySwal.fire({
                    ...
                    text: `"${name}" tiene ${count} plantilla(s) vinculada(s).`,
